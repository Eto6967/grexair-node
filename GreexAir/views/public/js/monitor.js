...
var _timeBarEl = document.getElementById('timeBarChart');
window.timeBarChart = _timeBarEl ? new Chart(_timeBarEl.getContext('2d'),{
    type:'bar',
...
function updateUI(payload){
    ...
    if(payload.timeStats&&window.timeBarChart){window.timeBarChart.data.datasets[0].data=payload.timeStats;window.timeBarChart.update('none');}
